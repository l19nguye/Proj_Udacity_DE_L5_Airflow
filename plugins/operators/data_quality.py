...
class DataQualityOperator(BaseOperator):
    '''
        ...
        Will have 2 parameters:
            ...
            - sql_check: the dictionary consist SQL commands using to count invalid records of each table 
                            and the result expected from each one of them.            
    ...
    def execute(self, context):
        """
            ...
            If the returned result is not equal to the expected one, 
            the table has at least one invalid record for sure.
            In that case, we will write informational log, 
